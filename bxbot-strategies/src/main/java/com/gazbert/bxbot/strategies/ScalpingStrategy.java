 ...
 * {@link TradingApi#getPercentageOfBuyOrderTakenForExchangeFee(String)} and
 * {@link TradingApi#getPercentageOfSellOrderTakenForExchangeFee(String)} when calculating
 ...
 * @author gazbert
 */
@Component("scalpingStrategy") // this is used to load the strategy using Spring bean injection
